...
def main():
    ...
    # This section defines the behavior of the "Instruction & Overview" page of the Sortify Movie Recommender App.
    if page_selection == "Instruction & Overview":
        # Displaying the title and an image at the top of the page
        ...
        # Providing a friendly greeting and introduction to the app
